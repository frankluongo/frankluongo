...
import { theme } from '../../Styles/utilities/Colors';
    ...
    return (
      <Wrapper backgroundColor={theme.gray2}>
        <AboutMeContent>
          ...
          <Paragraph>Looking for my work history? <a href="https://www.frankluongo.com/wp-content/uploads/FrankLuongoResume.pdf" target="_blank" rel="noopener noreferrer">Check out My Resumé</a></Paragraph>
          </div>
          <div>
